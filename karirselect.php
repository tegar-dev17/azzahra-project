...
<body>
    ...
    ?>
    <section id="karir" class="md:mt-20 md:mb-36 rounded overflow-hidden ">
        <div class="w-full px-4 flex flex-wrap container" id="satu">
            <div class="p-4 md:w-2/3 pt-5 md:mb-20">
                <div class="min-w-full max-w-md mx-auto bg-white rounded overflow-hidden ">
                    <div class="px-6 py-4 md:mb-16">
            ...
            <div class="p-4 md:w-1/3 md:pt-4">
                <div class="rounded min-w-full max-w-md mx-auto">
                    <div class="px-6 py-4 md:pt-9 pb-4">
                ...
                <br>
                <a href="cakar.php?id=<?= $karir['id']; ?>" class="mx-auto text-lg font-semibold text-white bg-blue-900 py-3 md:px-32 rounded-lg hover:shadow-lg transition duration-300 ease-in-out animate-pulse flex items-center justify-center">APPLY NOW!</a>
            </div>
