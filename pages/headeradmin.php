        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" id="notification-dropdown">
                    ...
                    <a href="pesan.php" class="dropdown-item dropdown-footer">Lihat Seluruh Pesan</a>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="kerangka.php" class="nav-link">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="inputkarir.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Input Karir</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="datakarir.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Data Karir</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="datacakar.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Data Cakar</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="arsip_pesan.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Arsip Pesan</p>
                                </a>
                            </li>
    ...
    <script>
        $(document).ready(function($) {
            ...
            function resetNotificationCount() {
                $.ajax({
                    url: 'reset_notification_count.php',
                    method: 'GET',
                    success: function() {
